var Zepto = function () {
    ...
    var a, b, c, d, A, B, e = [], f = e.concat, g = e.filter, h = e.slice, i = window.document, j = {}, k = {},
        ...
        s = ["after", "prepend", "before", "append"], t = i.createElement("table"), u = i.createElement("tr"),
    ...
    return z.matches = function (a, b) {
        ...
        var e;
        if (!b)return z.Z();
        if ("string" == typeof b)if (b = b.trim(), "<" == b[0] && m.test(b)) e = z.fragment(b, RegExp.$1, d), b = null; else {
            if (d !== a)return c(d).find(b);
            e = z.qsa(i, b)
        } else {
            if (G(b))return c(i).ready(b);
            if (z.isZ(b))return b;
            if (E(b)) e = M(b); else if (J(b)) e = [b], b = null; else if (m.test(b)) e = z.fragment(b.trim(), RegExp.$1, d), b = null; else {
                if (d !== a)return c(d).find(b);
                e = z.qsa(i, b)
            }
        }
        ...
        offset: function (a) {
            if (a)return this.each(function (b) {
                var d = c(this), e = W(this, a, b, d.offset()), f = d.offsetParent().offset(),
                    g = {top: e.top - f.top, left: e.left - f.left};
                "static" == d.css("position") && (g["position"] = "relative"), d.css(g)
            });
            if (!this.length)return null;
            if (i.documentElement !== this[0] && !c.contains(i.documentElement, this[0]))return {top: 0, left: 0};
        ...
        position: function () {
            if (this.length) {
                var a = this[0], b = this.offsetParent(), d = this.offset(),
                    e = p.test(b[0].nodeName) ? {top: 0, left: 0} : b.offset();
...
!function (a) {
    ...
    var c, t, u, v, w, b = 1, d = Array.prototype.slice, e = a.isFunction, f = function (a) {
        ...
        }, g = {}, h = {}, i = "onfocusin" in window, j = {focus: "focusin", blur: "focusout"},
...
!function (a) {
    ...
    l.href = window.location.href, a.active = 0, a.ajaxJSONP = function (d, e) {
        ...
        if (D = "async" in f ? f.async : !0, A.open(f.type, f.url, D, f.username, f.password), f.xhrFields)for (e in f.xhrFields)A[e] = f.xhrFields[e];
...
!function (a, b) {
    ...
    var d, h, i, j, k, l, m, n, o, p, c = "", e = {Webkit: "webkit", Moz: "", O: "o"},
    ...
    f.style.transform === b && a.each(e, function (a, e) {
        ...
        if (d === b && (d = a.fx.speeds._default / 1e3), s === b && (s = 0), a.fx.off && (d = 0), "string" == typeof c) u[m] = c, u[n] = d + "s", u[p] = s + "s", u[o] = e || "linear", z = a.fx.animationEnd; else {
            v = [];
